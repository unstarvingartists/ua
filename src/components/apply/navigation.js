  ...
  return (
    <Popover>
      {({ open }) => (
        <>
          <nav
            className="bg-white relative max-w-7xl mx-auto flex items-center justify-between px-4 sm:px-6"
            aria-label="Global"
          >
            <div className="flex items-center flex-1">
              <div className="flex items-center justify-between w-full md:w-auto py-6">
                <Link to="/">
                  <img
          ...
          >
            ...
            >
              <div className="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 bg-white divide-y-2 divide-gray-50">
                ...
                <Link
                  to="/apply"
                  className="block w-full px-5 py-3 text-center font-medium text-blue-600 bg-white hover:bg-gray-100"
                >
                  Apply Now
                </Link>
              </div>
