...
const navigation = {
  ...
  social: [
    ...
    {
      name: "Facebook",
      href: "https://www.facebook.com/harrywhelchelfan/",
      icon: (props) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
    ...
    {
      name: "LinkedIn",
      href: "https://www.linkedin.com/showcase/harrywhelchel/",
      icon: (props) => (
    ...
    {
      name: "Twitter",
      href: "https://twitter.com/therealharryw",
      icon: (props) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
        ...
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          ...
          {/*          <div className="mt-8 xl:mt-0">
            ...
            <p className="mt-3 text-sm text-gray-500">
              ...
              &{" "}
              <Link to="/legal/terms" className="font-medium underline">
                Terms.
              </Link>
            </p>
          </div>*/}
