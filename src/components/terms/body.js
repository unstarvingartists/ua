        ...
        <div className="max-w-7xl pt-6 mx-auto sm:px-6 lg:px-8">
          <div className="sm:grid sm:grid-cols-6 sm:gap-4">
            ...
            <div className="sm:col-start-2 sm:col-span-4">
              ...
              <div className="mt-20 prose prose-emerald prose-lg text-gray-500 mx-auto">
                ...
                <p>
                  The Academy comes with a 72 hour cancellation period. After 72
                  hours have passed, the program comes with our action-based
